...
<body <?php if($msg == "Login Successfully.") { ?>onload="changeHashOnLoad();"<?php } ?>>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="#"> <img alt="" src="<?php echo base_url();?>includes/images/pension-project-logo.png" /></a>
				...
				<div class="btn-group pull-right" >
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
						<i class="icon-user"></i><span class="hidden-phone">Member</span>
						<span class="caret"></span>
					</a>
	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<?php $this->load->view('administrator/menu/menu_home') ?>
				<!--/.well -->
			</div><!--/span-->
			<!-- left menu ends -->
