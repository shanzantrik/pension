...
<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered dataTable">
  <tr>
    ...
    <td width="22%"><?php  echo $records['details']['file_No']; ?></td>
    <input type="hidden" name="file_no" value="<?php  echo $records['details']['file_No']; ?>">
    <td width="15%"> <strong>Name</strong></td>
    <td width="39%"><?php  echo $records['details']['salutation'].' '.$records['details']['pensionee_name']; ?></td>
  </tr>
  <tr>
    <td><strong>Registration Number</strong></td>
    <td><?php  echo $records['details']['registration_no']; ?></td>
    <td><strong>Employee Code</strong></td>
    <td><?php  echo $records['details']['emp_code']; ?></td>
  </tr>
  <tr>
    <td><strong>Generated File No</strong></td>
    <td><?php  echo $records['details']['auto_file_no']; ?></td>
    <td><strong>Designation</strong></td>
    <td><?php  echo $records['details']['designation']; ?></td>
  </tr>
  <tr>
    <td><strong>Department Forwading No</strong></td>
    <td><?php  echo $records['details']['dept_forw_no']; ?></td>
    <td><strong>Department</strong></td>
    <td><?php  echo $records['details']['department_name']; ?></td>
  </tr>
  <tr>
    <td><strong>Receipt Date</strong></td>
    <td><?php  echo $records['receipt_date']; ?></td>
    <td><strong>Department Address</strong></td>
    <td><?php  echo $records['details']['address_department']; ?></td>    
  </tr>
  <tr>
    <td><strong>Received on Issue</strong></td>
    <td><?php  echo $records['dispatch_date']; ?></td>
    <td><strong>District</strong></td>
    <td><?php  echo getDistrictById($records['details']['district']); ?></td>
  </tr>
</table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="checkbox" name="chk[]" value="AG">AG Office <textarea></textarea><br />
                <input type="checkbox" name="chk[]" value="Treasury"> Treasury <textarea></textarea><br />
                <input type="checkbox" name="chk[]" value="to_the_department"> Department <textarea></textarea><br />
                <input type="checkbox" name="chk[]" value="office_copy"> Office Copy <textarea></textarea><br />
