...
<form class="form-horizontal" action="<?php echo site_url('administrator/Reauthorization/search_family'); ?>" method="post">
  	<div class="form-group">
    	<label for="inp" class="col-sm-2 control-label" style="text-align: left; font-weight: bold;">File No</label>
    	<div class="col-sm-6">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" name="create_worksheet" id="create_worksheet" class="btn btn-primary" disabled>Search</button>
        </div>
    </div>
</form>
