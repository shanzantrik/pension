...
<h3 id="observation-heading">pension observation entry <span>(Fields mark with (*) are mandatory fields.)</span></h3>
<?php $file_no = ($this->uri->segment('4') != '') ? base64_decode($this->uri->segment(4)) : ''; ?>

<form action="<?php echo site_url('administrator/DA_Notification/add'); ?>" method="post" name="pension_observation" id="pension_observation">
<div class="tab-pane active" id="personal_details">
    <legend style="font-size:15px; color:#3b5999; font-weight:700">Observation Panel » <small style="font-size:11px">Please enter personal information.</small></legend>
    <input type="hidden" name="action_type" id="action_type" value="add" />

    <div class="form-group">
        <label class="col-sm-6 control-label">File No <span class="required-field">*</span></label>
        <div class="col-sm-6">
            <input autocomplete="off" name="file_no" id="file_no" type="text" value="<?php echo $file_no; ?>" placeholder="Please Enter File No"><?php echo form_error('file_no', '<div class="error">', '</div>'); ?>
        </div>
    </div>
     <div class="form-group">
        <label class="col-sm-6 control-label">Title<span class="required-field">*</span></label>
        <div class="col-sm-6">
          <textarea rows="4" cols="20" name="title" id="title" class="form-control"></textarea><?php echo form_error('title', '<div class="error">', '</div>'); ?>
        </div>
    </div>
   
    <div class="form-group">
        <label class="col-sm-6 control-label">Remarks<span class="required-field">*</span></label>
        <div class="col-sm-6">
          <textarea rows="4" cols="20" name="remarks" id="remarks" class="form-control"></textarea><?php echo form_error('remarks', '<div class="error">', '</div>'); ?>
        </div>
    </div>
...
#personal_details .form-group {width: 80%; float: left; margin-left: 10px;}

#pension_observation {width: 98%;}
#pension_observation table{width: 90%;}
#pension_observation table .form-control{width: 132px;}
