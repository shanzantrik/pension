...
<div class="pay_details" id="7th" style="margin-top: 20px;">
    ...
    <input autocomplete="off" placeholder="case no"  type="text" id="case_file_no" name="case_file_no" value="">
        </div>
    </div>
    ...
    <input autocomplete="off" placeholder="ppo no"  type="text" id="ppo_file_no" name="ppo_file_no" value="">
        </div>
    </div>
    ...
    <input autocomplete="off" placeholder="gpo no"  type="text" id="gpo_file_no" name="gpo_file_no" value="">
        </div>
    </div>
    ...
    <input autocomplete="off" placeholder="cpo no"  type="text" id="cpo_file_no" name="cpo_file_no" value="">
        </div>
    </div>
    
    <div class="form-group" style="left; margin: 0px 20px;">
        <div class="col-sm-6">
            <label class="col-sm-3 control-label">Before Increament Value(Family Pension)</label>
