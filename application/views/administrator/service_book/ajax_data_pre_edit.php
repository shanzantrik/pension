        ...
        if($('#modaldearness_allowances').val()=='') {
            ...
            $.post("<?php echo site_url('administrator/service_book/save_DA'); ?>",{DA_value:$('#modaldearness_allowances').val()}, function(data) {
                ...
                if(isNaN(data) || data==""){
                    ...
                    $('#post_da').append('<option value='+data+' selected>'+$('#modaldearness_allowances').val()+'</option>');
                    $('#pre_da').append('<option value='+data+' selected>'+$('#modaldearness_allowances').val()+'</option>');
