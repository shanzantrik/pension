...
<div class="tab-pane active" id="personal_details">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <select name="religion" id="religion" class="multiselect">
                ...
                <?php $religion = array('Hindu', 'Muslim', 'Sikh', 'Christian', 'Buddhism', 'Others'); ?>
                <?php
    ...
    <?php if($row['class_of_pension']=='Normal_Family_Pension' && $NumberOfWives>1){ ?>
            <div class="form-group input_fields_wrap">
                <nobr><label class="col-sm-3 control-label">Address after Retirement <span class="required-field">*</span> <button class="add_field_button btn btn-success">Add</button></label></nobr>
                <?php 
                ...
                <tbody>
                 <tr id="parent-1" class="parent">
                    ...
                    foreach ($result as $r) {?>
                                        ...
                                        <tr id="parent-1" class="parent">
                        <td><input class="dod form-control" name="fidate[]" placeholder="From Increment Date" size="16" type="text" value="<?php echo $r->from_date;?>" id="fidate<?php echo $xx;?>[]">
                          <label style="font-size:12px; color:red"></label>                      </td>
                        <td><input class="dod form-control" name="toidate[]" placeholder="To Increment Date" size="16" type="text" value="<?php echo $r->to_date;?>" id="toidate<?php echo $xx;?>[]">
                        <label style="font-size:12px; color:red"></label></td>
                        <td><input  class=" form-control" name="irate[]" placeholder="Rate" size="16" type="text" value="<?php echo $r->rate_of_pay;?>" id="irate<?php echo $xx;?>[]">
                        <label style="font-size:12px; color:red"></label></td>
                        <td><input  class=" form-control" name="iamount[]" placeholder="Amount" size="16" type="text" value="<?php echo $r->amount;?>" id="iamount<?php echo $xx;?>[]">
                        <label style="font-size:12px; color:red"></label></td>
                    </tr> <?php  $xx=$xx+1; }?>
                    <tr class="parent">
                      <td><input class="dod form-control" name="fidate[]" placeholder="From Increment Date" size="16" type="text" value="" id="fidate2[]"></td>
                      <td><input class="dod form-control" name="toidate[]" placeholder="To Increment Date" size="16" type="text" value="" id="toidate2[]"></td>
...
<div class="tab-pane" id="treausry_details">
    ...
    <div class="form-group input_fields_wrap_subto full-form-group">
        ...
        <button class="add_field_button_subto btn btn-success">Add</button></label></nobr>
                <?php 
...
<script type="text/javascript">
    ...
    var getPensionCalc = function() {
        ...
        var x=$("#pay-commission").val();
        $.ajax({
            url: '<?php echo site_url("administrator/service_book"); ?>/pre_revised_edit?id='+x,
            dataType:'html',
            method:'GET',
