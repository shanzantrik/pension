...
<script type="text/javascript">
    $('body').on('focus', "#dob, #dor, #dom, #letter_date, #DNI_on, #doj, #doc, #pom_group_d_from, #pom_group_d_to, #pom_group_c_from, #pom_group_c_to, #pom_group_b_from, #pom_group_b_to, #pom_group_a_from, #pom_group_a_to, #cal_sav_amt_group_d_from, #cal_sav_amt_group_d_to, #cal_sav_amt_group_c_from, #cal_sav_amt_group_c_to, #cal_sav_amt_group_b_from, #cal_sav_amt_group_b_to, #cal_sav_amt_group_a_from, #cal_sav_amt_group_a_to, #d_of_settlement", function() {
        $(this).datepicker({
            dateFormat: 'yy-mm-dd',
            changeMonth: true,
            changeYear: true,
            ...
            <table class="table" id="example" aria-describedby="datatable_info" width="100%">
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr>
                        ...
                        <td>
                            <input title="letter_no" name="letter_no" value="<?php echo $letter_no;?>" type="text" class="form-control parsley-validated" placeholder="Letter No">
                            <?php echo form_error('office_address', '<div class="error">', '</div>'); ?>
                            <br/>
                        </td>
                        <td><strong>Date</strong></td>
                        <td>
                            <input title="Letter Date" name="letter_date" id="letter_date" type="text" value="<?php echo $letter_date;?>" class="form-control parsley-validated" placeholder="Provide Date of Retirement">
                            <?php echo form_error( 'doj', '<div class="error">', '</div>'); ?>
                        </td>
