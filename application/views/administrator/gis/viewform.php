...
<?php
    ...
    if($branch_code == '1001') {
        ...
        //$district_name=getDistrictById($districtID);
        $district_name='';
        //$ac = ($record['treasury_officer']!='') ? str_replace(", ", ",<br />",$record['treasury_officer']): str_replace(", ", ",<br />", $record['sub_to']) ;
    //print_r($ac);
    	$dob ='';
...
The employee (in case of Death of Govt. Servant)
                    ...
                    <tr>
                        ...
                        <td><input title="Name"  name="district" value="<?php echo $district_name;?>" type="text" class="form-control parsley-validated" placeholder="Please Enter District"><?php echo form_error('district', '<div class="error">', '</div>'); ?></td>
                        <td></td>
...
to Autonomous Body/PSUs from service & designation</label></td>
 ...
 Sanction from Head of Office exists/does not exist, ( if exists the amount):-</label></td> 
                    ...
                    <tr>
                        <td colspan="5">
                            <b><?php echo nbs(2);?>(i)<?php echo nbs(2);?><input title="Provide Fixed Pay" name="final_insurance_amt" type="radio" value="120000"   class="form-control parsley-validated" placeholder="">
                            <?php echo nbs(2);?>Group ‘A’ ---- Rs 1, 20,000/-</b><?php echo nbs(2);?>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="5">
                            <b><?php echo nbs(2);?>(ii)<?php echo nbs(2);?><input title="Provide Fixed Pay" name="final_insurance_amt" type="radio" value="60000"   class="form-control parsley-validated" placeholder="">
                            <?php echo nbs(2);?>Group ‘B’ ---- Rs 60,000/-</b><?php echo nbs(2);?>
                        </td>                                                    
                    </tr>
                    <tr>
                        <td colspan="5">
                            <b><?php echo nbs(2);?>(iii)<?php echo nbs(2);?><input title="Provide Fixed Pay" name="final_insurance_amt" type="radio" value="30000"   class="form-control parsley-validated" placeholder="">
                            <?php echo nbs(2);?>Group ‘C’ ---- Rs 30,000/-</b><?php echo nbs(2);?>
                        </td>                                                    
                    </tr>
                    <tr>
                        <td colspan="5">
                            <b><?php echo nbs(2);?>(iv)<?php echo nbs(2);?><input title="Provide Fixed Pay" name="final_insurance_amt" type="radio" value="15000"   class="form-control parsley-validated" placeholder="">
                    ...
                    <tr>
                      ...
                      <tr>
                          <td>
                            <label style="width:auto;font-weight:bold" class="col-sm-3 control-label">Letter No</label>
                        </td>
                        <td>
                            <input title="letter_no" name="letter_no"  type="text" class="form-control parsley-validated" placeholder="Letter No">
                            <?php echo form_error('office_address', '<div class="error">', '</div>'); ?>
                            <br/>
                        </td>
                        <td><strong>Date</strong></td>
                        <td>
                            <input title="Letter Date" name="letter_date" id="letter_date" type="text"  class="form-control parsley-validated" placeholder="Provide Letter date">
