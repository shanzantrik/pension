...
<form method="POST" action="<?php echo site_url('administrator/pension/revision_save'); ?>" accept-charset="UTF-8">   
    <div class="form-group">
        ...
        <select name="revision_type" id="revision_type" class="form-control" required>
    ...
    <input type="hidden" id="pay_commission" name="pay_commission" value="<?php echo $data->pay_commission;?>">
    ...
    <div class="form-group" id="e">
        ...
        <input class="form-control" id="pay_band_pay"  autocomplete="off" name="pay_band_pay" type="number" step="any" placeholder="Pay in pay band" style="width: 23%">+<input class="form-control" id="pay_band_grade_pay" autocomplete="off" name="pay_band_grade_pay" type="number" step="any" placeholder="Grade pay" style="width: 23%"> = <input readonly class="form-control" id="fifty_of_pay_band_plus_grade_pay"  autocomplete="off" name="fifty_of_pay_band_plus_grade_pay" type="text" placeholder="50% of minimum of pay in pay Band Plus Grade Pay" style="width: 33%"> 
    </div>
    ...
    <div class="form-group">
        <input readonly class="form-control" id="pre_revised_cop" required="required" autocomplete="off" name="pre_revised_cop" type="hidden" placeholder="preRevised Commutation of Pension">
    ...
    <div class="form-group">
        <label for="pension_enhanced" class="control-label max-height">Letter No</label>
    ...
    <div class="form-group">
        <label for="pension_enhanced" class="control-label max-height">Previous DA</label>
        <input class="form-control" id="pension_enhanced" required="required" autocomplete="off" name="pension_enhanced" value="<?php echo $increament_DA;?>" readonly type="text" placeholder="">
    </div>
...
<div id="revised_gratuity_form" style="display:none">
<form method="POST" action="<?php echo site_url('administrator/pension/revision_save_rg'); ?>" accept-charset="UTF-8">
  <div class="form-group">
        <label for="dob" class="control-label">Revision Type</label>
        <select name="revision_type_rg" id="revision_type_rg" class="form-control" required>
            <option value="">--Select--</option>
            <option value="acp">ACP</option>
            <option value="macp">MACP</option>
            <option value="additional_increament">Additional Increament</option>
...
<div class="form-group">
    ...
    <div class="form-group">
     ...
     <div class="form-group" id="b">
        <label for="amount_of_pension_pre_revised" class="control-label max-height">Amount of Pension/family pension Sanctioned in pre-revised scale of pay</label>
        <input readonly class="form-control" id="amount_of_pension_pre_revised_rg" required="required" autocomplete="off" value="<?php echo (isset($data->amountofpension)) ? $data->amountofpension : getAmountofPension($data->serial_no, true); ?>" name="amount_of_pension_pre_revised_rg" type="number" step="any" placeholder="Amount of Pension/family pension Sanctioned in pre-revised scale of pay">
    </div>

    <div class="form-group">
        <label for="revised_scale_pay" class="control-label">Revised scale of pay w.e.f. 1-1-2006</label>
        <input readonly class="form-control" id="revised_scale_pay_view" required="required" autocomplete="off" name="revised_scale_pay_view" type="text" placeholder="Six monthly period" value="<?php echo getPayScaleGradeById($data->pay_scale).' '. getPayScaleById($data->pay_scale); ?>">
    </div>

    <div class="form-group">
        <label for="last_pay" class="control-label">Last pay in Pay Band + Gd. Pay</label>
        <input class="form-control" id="last_pay_rg" value="<?php echo $post_BP;?>" required="required" autocomplete="off" name="last_pay_rg" type="number" step="any" placeholder="Last pay in Pay Band" style="width: 23%">+<input class="form-control" id="grade_pay_rg" required="required" autocomplete="off" name="grade_pay_rg" type="number" step="any" value="<?php echo $post_GP;?>" placeholder="Grade pay" style="width: 23%"> = <input readonly class="form-control" id="revised_total" required="required" autocomplete="off" value="<?php echo $post_BP+$post_GP;?>" name="revised_total_rg" type="text" placeholder="Total" style="width: 33%">
    </div>

    <div class="form-group">
        <label for="last_pay" class="control-label">Amount of revised D.C.R.G-Amount of prerevised D.C.R.G</label>
        <input readonly class="form-control" id="revised_dcrg_rg" required="required" autocomplete="off" name="revised_dcrg_rg" type="number" step="any" placeholder="" style="width: 23%"> -
        <input class="form-control" id="prerevised_dcrg_rg" required="required" autocomplete="off" name="prerevised_dcrg_rg" value="<?php echo (isset($data->prerevised_dcrg)) ? $data->prerevised_dcrg : $getDCRG; ?>" type="number" step="any" placeholder="" style="width: 23%"> = 
        <input readonly class="form-control" id="total_payable_rg" required="required" autocomplete="off" name="total_payable_rg" type="text" placeholder="Total" style="width: 33%">
    </div>
    <div class="form-group">
        <label for="pension_enhanced" class="control-label max-height">Previous DA</label>
        <input class="form-control" id="pension_enhanced" required="required" autocomplete="off" name="pension_enhanced" value="<?php echo $increament_DA;?>" readonly type="text" placeholder="">
    ...
    <div class="form-group">
        <label for="last_pay" class="control-label">Dearness Allowance</label>
        <select required class="form-control revision_da_rg" name="revision_da_rg" id="revision_da_rg">
            <option value="">Select</option>
            <?php foreach (getall_DA() as $da) { ?>
                <?php if($da['da'] == $data->revision_da) : ?>
                    <option value="<?php echo $da['da'];?>" selected><?php echo $da['da']; ?></option>
    ...
    <div class="form-group">
        <label for="revised_scale_pay" class="control-label">Revised scale of pay w.e.f. 1-1-2006</label>
        <input readonly class="form-control" id="revised_scale_pay" required="required" autocomplete="off" name="revised_scale_pay" type="text" placeholder="Six monthly period" value="<?php echo $data->pay_scale;?>">
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
     $('#revision_type').change(function(){
        //var me = $(this);
        var a=$('#revision_type').val() ;
        if(a=="revised_gratuity"){
         $('#form1').hide();
         $('#revised_gratuity_form').show();
        }else{
       $('#form1').show();
       $('#revised_gratuity_form').hide();

        }
 
     });

     $('#revision_type_rg').change(function(){
        //var me = $(this);
        var a=$('#revision_type').val() ;
        if(a=="acp" || a=="macp" || a=="additional_increament" || a=="refixation_of_pay" || a==""){
         $('#form1').show();
         $('#revised_gratuity_form').hide();
        }else if(a=="revised_gratuity"){
       $('#form1').hide();
       $('#revised_gratuity_form').show();
      ...
      $('#revision_da_rg').change(function(){
     
         //alert($('#revision_da_rg').val());
         $.post('<?php echo site_url("administrator/pension/get_revision_dcrg"); ?>', {serial_no: $('#serial_no').val(), basic_pay: $('#last_pay_rg').val() || 0, grade_pay: $('#grade_pay_rg').val() || 0, revision_da: $('#revision_da_rg').val()}, function(result) {
            if(result == 'redirect') {
                window.location = '<?php echo site_url("administrator/pension/revision_index"); ?>';
            } else {
                $('#revised_dcrg_rg').val(result);
                var revised_dcrg_rg = parseFloat($('#revised_dcrg_rg').val()) || 0;
                var prerevised_dcrg_rg = parseFloat($('#prerevised_dcrg_rg').val()) || 0;
                $('#total_payable_rg').val(revised_dcrg_rg-prerevised_dcrg_rg);
                //$('#total_payable_rg').val($('#revised_dcrg_rg').val(result));
   ...
   // if($('#revised_scale_pay').val() == '') {
    ...
    //alert(revised_amount_of_pension);
    var amount_of_pension_pre_revised = parseFloat($('#amount_of_pension_pre_revised').val()) || 0;
    //alert(amount_of_pension_pre_revised);
    var pay_commission =$('#pay_commission').val() || 0;
    var com_applied =$('#com_applied').val() || 0;
       //alert(com_applied);
    $.post('<?php echo site_url("administrator/pension/get_revision_commutation_of_pension"); ?>', {pay_commission: pay_commission,amountofPension: revised_amount_of_pension, age_at_retirement: $('#age_at_retirement').val(), class_of_pension: $('#class_of_pension').val()}, function(data) {
    if(re_com_applied==1){
...
$.post('<?php echo site_url("administrator/pension/get_revision_commutation_of_pension"); ?>', {pay_commission: pay_commission,amountofPension: amount_of_pension_pre_revised, age_at_retirement: $('#age_at_retirement').val(), class_of_pension: $('#class_of_pension').val()}, function(data) {
        if(com_applied==1){
        $('#pre_revised_cop').val(data);
        }else{
        $('#pre_revised_cop').val('N/A');
        }
        });
  })
