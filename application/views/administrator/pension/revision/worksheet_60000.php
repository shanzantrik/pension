...
<table width="100%" border="0" cellpadding="2" id="report">
	...
	<tr>
		...
		<td>:</td>
		<td><?php echo $fifty_of_ae;
		//if($val['dod']=="0000-00-00"){echo $val['fifty_of_ae'];}else{echo "N/A";}?>
	...
	<tr>
		...
		<td style="border-bottom: 2px dotted;"><b> ii)Gratuity already withdrawn</b></td>
		<td>:</td>
	...
	<tr>
		<td><div align="right"></div></td>
		<td style="border-bottom: 2px dotted;"><b> ii)Commutation already withdrawn</b></td>
		<td>:</td>
		<td><b style="border-bottom: 2px dotted; font-weight: normal; padding-bottom: 4px;"><?php if($val['com_applied']==1){echo $val['pre_revised_cop'];}else{echo "Not Applied";}?></b></td>
	</tr>
	<tr>
		<td><div align="right"></div></td>
		<td align="center"><b> To be Paid</b></td>
		<td>:</td>
		<td><?php if($val['com_applied']=="1"){echo $val['pre_revised_cop']-$val['revised_cop'];}else{ echo $val['revised_cop'];}?></td>
	</tr>
	...
	<tr>
		...
		<td>:</td>
		<td><?php if(($val['dod']=="0000-00-00" && $val['dor']!="0000-00-00") || ($val['dor']!="0000-00-00" && $val['dod']>$val['dor']) ){echo $val['revised_reduced_pension'];}else{echo "N/A";}?>
		</td>
	</tr>
	<tr>
