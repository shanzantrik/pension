...
<div id="print" style="width:1000px; margin:0px auto;">
	<div style="width: 1000px; min-height: 600px; font-size: 1.1em; color:#000000; background-color: #FFFFFF; line-height: 1.5em">
...
<table width="100%" border="0" cellpadding="2" id="report">
	...
	<tr>
		<td valign="true" ><div align="right">11.</div></td>
		<td><b>Amount of <?php if($val['dor']=="0000-00-00" && $val['dod']!="0000-00-00"){ echo "Family Pension "; }else{ echo "Pension ";} ?><br>
	...
	<tr>
		<td valign="true" ><div align="right">14.</div></td>
	...
	<tr>
		<td valign="true" ><div align="right">16.</div></td>
		<td><b>Amount of <?php if($val['dor']=="0000-00-00" && $val['dod']!="0000-00-00"){ echo "Family Pension "; }else{ echo "Pension ";} ?><br>
	...
	<?php //if(($val['dod']=="0000-00-00" && $val['dor']!="0000-00-00") || ($val['dor']!="0000-00-00" && $val['dod']>$val['dor'])){
     if($val['dod']=="0000-00-00" && $val['dor']!="0000-00-00"){
     	//print_r($val['re_com_applied'].''.$val['com_applied']);
