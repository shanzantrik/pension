...
<table align="center" border="1" class="table table-striped table-bordered table-condensed">
	...
	<tr>
		...
		<td><b>Date of absorption</b></td>
		<td><?php echo $pensioner->dateTimeToDate($pensioner->dor); ?></td>
	</tr>
	<tr>
		<td><b>Age at absorption</b></td>
	...
	<tr>
		<td><b>Service Gratuity</b></td>
		<td colspan="3"><?php echo $pensioner->getServiceGratuity(); ?></td>
	</tr>
	<tr>
	...
	<tr>
		<td><b>Gratuity</b></td>
		<td><?php echo $pensioner->getGratuity(); ?></td>
		<td><b>Terminal Gratuity</b></td>
		<td><?php echo $pensioner->getTerminalGratuity(); ?></td>
	</tr>
	<tr>
