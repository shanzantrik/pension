...
<?php
	$detail = "Pension Category ".$pensioner->pension_category;
	$detail.= (!empty($pensioner->pension_scheme)) ? " | Pension Scheme ".$pensioner->pension_scheme : '';
	$detail.= (!empty($pensioner->pension_for)) ? " | Pension For ".ucwords(str_replace("_", " ", $pensioner->pension_for)) : '';
?>
<h4>Pension -> Family -> <?php echo str_replace("_", " ", $pensioner->class_of_pension); ?> (<?php echo $detail; ?>)</h4>
