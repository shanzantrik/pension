 ...
 ?>
	...
	<div id="print1" style="width: 900px; margin: 0px auto;">
		...
		<table width="100%" border="0" cellpadding="2" id="report">
     		<tr>
				<td colspan="4"><div align="left">File No. DA/GIS/86/<b><?php echo $val['file_no']?></b><strong></strong></div></td>
			...
			<tr>
				<td colspan="5">(i)	Savings Fund Rs <b><?php if(!$val['total_cal_sav_amt_group_d']=="0"){ echo round($val['total_cal_sav_amt_group_d']); } else { echo ""; } if(!$val['total_cal_sav_amt_group_c']=="0"){ echo round($val['total_cal_sav_amt_group_c']); } else { echo ""; }?><?php if(!$val['total_cal_sav_amt_group_c']=="0"){ echo round($val['total_cal_sav_amt_group_c']); } else { echo ""; }?><?php if(!$val['total_cal_sav_amt_group_a']=="0"){ echo round($val['total_cal_sav_amt_group_a']); } else { echo ""; }?></b> /-(Rupees __________________________) only. The expenditure is debit able the Head of Account ‘8658’ suspense finally adjustable under Major Head 8011 Insurance & Pension Fund.</td>
			</tr>
			<tr>
				<td colspan="5">(ii) Insurance Rs <b><?php if(!$final_insurance_amt=="0"){ echo " ".$final_insurance_amt."  ";} else{echo "----------------";}?></b> (Rupess_______________________________) only. The expenditure is debitable the Head of Account ‘8658’ suspense finally adjustable under Major Head-8011, Insurance & Pension Fund.</td>
			</tr>  
			<tr>
			...
			<tr>
				<td width="30%"><div align="left">Memo No.DA/GIS/86/<b><?php echo $val['file_no']?></b><strong></strong></div></td>
