	...
	<div id="print2" style="width: 900px; margin: 0px auto;">
		...
		<table width="100%" border="0" cellpadding="2" id="report">
          ...
          <tr>
			...
			<tr>
				<td  colspan="5"><div align="left">Group D from <b><?php if(!$cal_sav_amt_group_d_from=="0"){ echo " ".$cal_sav_amt_group_d_from."  ";} else{echo "-------------------";}?></b>to <b><?php if(!$cal_sav_amt_group_d_to=="0"){echo " ".$cal_sav_amt_group_d_to."  ";} else {echo "-------------------";}?></b>Rs <b><?php echo $val['cal_sav_amt_group_d']?></b>X 2 unit = Rs <?php echo $val['total_cal_sav_amt_group_d']?></div></td>
			</tr>
			<tr>
				<td  colspan="5"><div align="left">Group C from <b><?php if(!$cal_sav_amt_group_c_from=="0"){ echo " ".$cal_sav_amt_group_c_from."  ";} else{echo "-------------------";}?></b>to <b><?php if(!$cal_sav_amt_group_c_to=="0"){echo " ".$cal_sav_amt_group_c_to."  ";} else {echo "-------------------";}?></b>Rs <b><?php echo $val['cal_sav_amt_group_c']?></b>X 4 unit = Rs <?php echo $val['total_cal_sav_amt_group_c']?></div></td>
			</tr>
			<tr>
				<td  colspan="5"><div align="left">Group B from <b><?php if(!$cal_sav_amt_group_b_from=="0"){ echo " ".$cal_sav_amt_group_b_from."  ";} else{echo "-------------------";}?></b>to <b><?php if(!$cal_sav_amt_group_b_to=="0"){echo " ".$cal_sav_amt_group_b_to."  ";} else {echo "-------------------";}?></b>Rs <b><?php echo $val['cal_sav_amt_group_b']?></b>X 6 unit = Rs <?php echo $val['total_cal_sav_amt_group_b']?></div></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="5"><div align="right">Total = <?php if(!$val['total_cal_sav_amt_group_d']=="0"){ echo round($val['total_cal_sav_amt_group_d']); } else { echo ""; } if(!$val['total_cal_sav_amt_group_c']=="0"){ echo round($val['total_cal_sav_amt_group_c']); } else { echo ""; }?><?php if(!$val['total_cal_sav_amt_group_c']=="0"){ echo round($val['total_cal_sav_amt_group_c']); } else { echo ""; }?><?php if(!$val['total_cal_sav_amt_group_a']=="0"){ echo round($val['total_cal_sav_amt_group_a']); } else { echo ""; }?></div></td>
			</tr>
			<tr>
