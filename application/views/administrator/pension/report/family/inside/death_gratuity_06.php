		...
		<div style="width:1000px; min-height:600px; font-size: 1.2em; color:#000000; background-color:#FFFFFF; line-height: 1.5em">
			<table width="100%" cellpadding="3" id="report" border="0">
				...
				<tr>
			 	...
			 	<tr>
					<td style="vertical-align: top; text-align: justify;" colspan="4" align="left"><?php echo nbs(13); ?>The gratuity payment orders whose details are given below in favour of &nbsp;<?php //echo $spouse.'('.$spouse_type.') ';
					if($NumberOfWives==1){
						echo $pensioner->getNameOfLegalHeir();	
					}else{
						echo $pensioner->getNameOfLegalHeirX($i+1);
					}
					?> of<?php echo nbs(1).strtoupper($pensioner->salutation." ".$pensioner->name);?>, <?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation; ?></b>&nbsp;are forwarded herewith for payment from your end.</td>
				</tr>	
			 	<tr>
					<td style="vertical-align: top;" colspan="4">
		1. Category of Pension 						:- <span><?php echo str_replace("_", " ", $class_of_pension); ?></span></td></tr>
				
				<tr>
					<td style="vertical-align: top;" colspan="4">
					2. No. <?php echo $gpo_no; ?> and amount of Retirement/Death gratuity :- <b>Rs. <?php //if($pensioner->pay_commission==7){ echo $binc;} else{ echo $pensioner->getDCRG();} 
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
					3. Name of Treasury/Bank where payable 	:- <b><?php echo $payable; ?></b>
					</td>
				</tr>
				<tr>
					<td style="vertical-align: top;" colspan="4">
					4. Provisional pension :- <b>Rs. <?php echo $pensioner->provisional_pension; ?></b>
					</td>
				</tr>
				<tr>
					<td style="vertical-align: top;" colspan="4">
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
						...
						echo $pensioner->getNameOfLegalHeirX($i+1);
					}?> of<?php echo nbs(1).strtoupper($salutation." ".$pensioner->name);?>, <?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation.',<br />'.$pensioner->getAddressAfterRetirement($i); ?>
			...
			<table width="100%" border="0" cellpadding="2" id="report">
				...
				<tr>
					<td colspan="4" style="padding: 5px 0;"><div align="left">i. <b><?php if($NumberOfWives==1){
						...
						echo $pensioner->getNameOfLegalHeirX($i+1);
					} ?> of <?php echo strtoupper($pensioner->salutation." ".$pensioner->name).", Retd. ".$pensioner->designation;?></b></div></td>
			    </tr>
			   	<tr>
			...
			<table width="100%" border="0" cellpadding="2" id="report">
				...
				<?php
					...
					<td colspan="2" valign="top" style="padding: 10px 0;">
		                ...
		                echo $pensioner->getDCRG();
		                ?>/-</b></br>
		                <b>COMMUTATION <!-- RS. <?php if($pensioner->pay_commission==7 && $pensioner->dor==$pensioner->dod){ echo 'N/A';}elseif($pensioner->pay_commission==7){ echo $bigbazars;} else{echo $pensioner->getCommutationOfPension();} ?>/- --><b>N/A</b></br>
				...
				<tr>
		      	...
		      	<tr>
					...
					?> --> N/A (Enhanced Rate)</b></br><b><!-- Rs. <?php 
			 ...
			 ?> -->
					<!-- <?php if($pensioner->pay_commission==7){echo $total_amount*30/100;} else{echo $pensioner->getOrdinaryRate();} ?> -->N/A (Ordinary Rate)</b></td>
				</tr>
			 	<tr>
					<td colspan="2" valign="top" style="padding: 10px 0 20px 20px;"><div align="left"> (b) To whom admissible </div></td>
					<td colspan="2" valign="top" style="padding: 10px 0;"><b><?php //echo $pensioner->getNameofSpouseD(); 
					if($NumberOfWives==1){
						echo $pensioner->getNameOfLegalHeir();	
					}else{
						echo $pensioner->getNameOfLegalHeirX($i+1);
	 			...
	 			<tr>
					...
					<td colspan="2" valign="top" style="padding: 10px 0 20px 0;"><b><!-- As per order from time to time -->N/A</b></td>
				</tr>
	 			<tr>
				...
				<tr>
					...
					<td colspan="2" valign="top" style="padding: 10px 0;">
						<b>1) PPO No. <!-- <?php echo $pensioner->ppo_no; ?> -->N/A</b></br>
