...
//seven pay
	...
	//seven
//echo $enhan_upto_seven->format('d-m-Y');
//die();
		...
		<div style="width:1000px; min-height:600px; font-size: 1.2em; color:#000000; background-color:#FFFFFF; line-height: 1.5em">
			<table width="100%" cellpadding="3" id="report" border="0">
				...
				<tr>
			 	...
			 	<tr>
					<td style="vertical-align: top; text-align: justify;" colspan="4" align="left"><?php echo nbs(13); ?>The gratuity payment order whose details are given below in favour of &nbsp;<?php //echo $spouse.'('.$spouse_type.') ';
					if($NumberOfWives==1){
		...
		1. Category of Pension 						:- <span><?php echo str_replace("_", " ", $class_of_pension); ?></span>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
						...
						echo $pensioner->getNameOfLegalHeirX($i+1);
					}?> of<?php echo nbs(1).strtoupper($pensioner->salutation." ".$pensioner->name);?>, <?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation.',<br />'.$pensioner->getAddressAfterRetirement($i); ?>
			...
			<table width="100%" border="0" cellpadding="2" id="report">
				...
				<tr>
					...
					if($NumberOfWives==1){
						...
						echo $pensioner->getNameOfLegalHeirX($i+1);
					}?> of<?php echo nbs(1).strtoupper($pensioner->salutation." ".$pensioner->name);?>,<?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation; ?></b> <?php  ?> being the amount of retirement/death gratuity sanctioned to him/her in letter no. <b><?php echo $gpo_no; ?></b> from the Director of Audit & Pension, debitable to 2071 Pension & ORB etc.</div></td>
				</tr>
				<tr>
				...
				<tr>
					...
					if($NumberOfWives==1){
						...
						echo $pensioner->getNameOfLegalHeirX($i+1);
					}?> of<?php echo nbs(1).strtoupper($pensioner->salutation." ".$pensioner->name);?>,<?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation; ?>  <?php 
					$Entrydate = new DateTime($pensioner->doj);
					$EntryYear = $Entrydate->format("Y");
					if($EntryYear>='2008')
			...
			<table width="100%" border="0" cellpadding="2" id="report">
				...
				<tr>
					...
					if($NumberOfWives==1){
						...
						echo $pensioner->getNameOfLegalHeirX($i+1);
					}?> of<?php echo nbs(1).strtoupper($pensioner->salutation." ".$pensioner->name);?>, <br /><?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation; ?></b> <?php  ?></td>
				</tr>
				<tr>
				...
				<?php
					...
					<td colspan="2" valign="top" style="padding: 10px 0;">
						...
						if($pdoj>=2008){
							...
							if($pensioner->pay_commission==7){ echo $total_amount_pension ;} else{echo $amount_pension;}
						}
						?>/-
						</b></br>
