	...
	<div id="print1" style="width: 1000px; margin: 0px auto;">
		<div style="width:1000px; min-height:600px; font-size: 1.2em; color:#000000; background-color:#FFFFFF; line-height: 1.5em">
			<table width="100%" cellpadding="3" id="report" border="0">
				...
				<tr>
			 	...
			 	<tr>
					<td style="vertical-align: top; text-align: justify;" colspan="4" align="left"><?php echo nbs(13); ?>The pension payment orders/GPO whose details are given below in favour of &nbsp;<?php //echo $spouse.'('.$spouse_type.') ';
					echo $pensioner->getNameOfLegalHeir();?> of<?php echo nbs(1).strtoupper($salutation." ".$pensioner->name);?>, <?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation; ?></b>&nbsp;are forwarded herewith for payment from your end.</td>
				</tr>	
			 	<tr>
		...
		3.  (a) Adhoc/Temporary increase
		    ...
		    (d) Family Pension in case of death of the Pensioner 	:-<b><?php if($pensioner->pay_commission==7){ echo  $total_amount*50/100;} else{echo $amount_pension;}?></b>
			  ...
			  ?><!-- <?php if($pensioner->pay_commission==7){ echo ($total_amount*50/100);} else{echo $pensioner->getEnhanceRate_sanjay(false);} ?> from <?php echo $enhan_from->format('d-m-Y')?> upto <?php echo $enhan_upto->format('d-m-Y');//echo $sanjay_enhance;//$enhan_upto->format('d-m-Y');?> --></b>
						</pre>
					</td>
				</tr>
				<tr>
			 ...
			 ?>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
						...
						echo $pensioner->getNameOfLegalHeir();?> of<?php echo nbs(1).strtoupper($salutation." ".$pensioner->name);?>, <?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation.',<br />'.$pensioner->address_after_retirement; ?>
		...
		<!-- <div style="width:1000px; min-height:600px; padding: 0 20px; font-size: 1.1em; color:#000000; background-color:#FFFFFF; line-height: 2em"> -->
			...
			<table width="100%" border="0" cellpadding="2" id="report">
				...
				<tr>
					...
					echo $pensioner->getNameOfLegalHeir();?> of<?php echo nbs(1).strtoupper($salutation." ".$pensioner->name);?>,<?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation; ?></b> <?php  ?> being the amount of retirement/death gratuity sanctioned to him/her in letter no. <b><?php echo $gpo_no; ?></b> from the Director of Audit & Pension, debitable to 2071 Pension & ORB etc.</div></td>
				</tr>
				<tr>
		...
		<div style="width:1000px; min-height:600px; font-size: 1.2em; color:#000000; background-color:#FFFFFF; line-height: 1.5em">
			...
			<table width="100%" border="0" cellpadding="2" id="report">
				...
				<tr>
					...
					echo $pensioner->getNameOfLegalHeir();?> of<?php echo nbs(1).strtoupper($salutation." ".$pensioner->name);?>, <br /><?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation; ?></b> <?php  ?></td>
				</tr>
				<tr>
