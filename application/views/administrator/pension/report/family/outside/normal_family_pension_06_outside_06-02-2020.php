				...
				<tr>
			 	...
			 	<tr>
					<td style="vertical-align: top;" colspan="3">
						...
						{ 
							echo str_replace(", ", ",<br />", $pensioner->getTg($i));
						}
					...
					<table border="1" cellspacing="2" cellpadding="2" id="inner-table">
						...
						<tr>
							...
							if($temp_result[0]["lap_amount"]!="" || $temp_result[0]["lap_amount"]!=NULL){
								echo "Life time arrear pension w-e-f: ".$temp_result[0]["lap_from"]." to ".$temp_result[0]["lap_to"]." amount of ".$temp_result[0]["lap_amount"]."</br>";
							}
							?>
