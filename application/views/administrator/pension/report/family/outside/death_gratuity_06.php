...
if(count($pensioner->getNameofSpouseD())==1) {
	$spouse=explode('-',$pensioner->getNameofSpouseD());
	$spouse2ndpart=$spouse[1];
	$spouse_type=explode('(',$spouse2ndpart);
	$spouse_type=$spouse_type[0];
	$spouse=$spouse[0];
} else {
	$spouse=$pensioner->getNameofSpouseD();
	$spouse_type="";
}
...
<div id="form1" style="display: block;">
	...
	<div id="print1" style="width: 1000px; margin: 0px auto;">
		...
		1. Category of Pension 						:- <span><?php echo str_replace("_", " ", $class_of_pension); ?></span>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
					3. Name of Treasury/Bank where payable 	:- <b><?php echo $pensioner->sub_to; ?></b>
					</td>
				</tr>
				<tr>
					<td style="vertical-align: top;" colspan="4">
					4. Provisional pension :- <b><?php 
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
					5. Provisional Retirement/Death Gratuity :- <b>Rs. <?php echo $pensioner->provisional_gratuity; ?></b>
					</td>
				</tr>
				<tr>
					<td style="vertical-align: top;" colspan="4">
					6. Conditions attached to pension payment may be made subject to the conditions specified in the PPO as well as the C.C.S. Pension Rules and Treasury Rules.
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
						...
						<b>1) <?php echo $spouse.'('.$spouse_type.') ';?>of<?php echo nbs(1).strtoupper($salutation." ".$pensioner->name);?>, <?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation.',<br />'.$pensioner->address_after_retirement; ?></b><br /><br />
		...
		<div style="width:1000px; min-height:600px; font-size: 1.2em; color:#000000; background-color:#FFFFFF; line-height: 1.5em">
			...
			<table width="100%" border="0" cellpadding="2" id="report">
			   ...
			   <tr>
				...
				<tr>
					<td colspan="4" style="padding: 10px 0;"><div align="left" style="text-align: justify;">i.<b><!--<?php echo $spouse.'('.$spouse_type.') ';?>of<?php echo nbs(1).strtoupper($salutation." ".$pensioner->name);?>,<?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation; ?>-->
					<?php echo $pensioner->getNameOfLegalHeir();?> of<?php echo nbs(1).strtoupper($salutation." ".$pensioner->name);?>,<?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation; ?>, <?php 
					$Entrydate = new DateTime($pensioner->doj);
					$EntryYear = $Entrydate->format("Y");
					if($EntryYear>='2008')
			...
			<table width="90%" border="0" cellpadding="2" id="report">
				...
				<tr>
		      	...
		      	<tr>
					...
					<td colspan="2" valign="top" style="padding: 10px 0;"><b> N/A (Enhanced Rate)</b></br><b>N/A</b> (Ordinary Rate)</b></td>
				</tr>
			 	<tr>
					<td colspan="2" valign="top" style="padding: 10px 0 20px 20px;"><div align="left"> (b) To whom admissible </div></td>
					<td colspan="2" valign="top" style="padding: 10px 0;"><b><?php echo $pensioner->getNameofSpouseD(); ?></b></td>
				</tr>
	 			<tr>
					<td colspan="2" valign="top" style="padding: 10px 0 20px 20px;"><div align="left"> (c) D.R admissible </div></td>
					<td colspan="2" valign="top" style="padding: 10px 0 20px 0;"><b>N/A</b></td>
				</tr>
	 			<tr>
			...
			<tr>
				<td style="vertical-align: top;" colspan="4">
					<table border="1" cellspacing="2" cellpadding="2" id="inner-table">
						...
						<tr>
							...
							<td style="vertical-align: top; text-align: center;" width="20%"><!--Life time arrear pension of Rs. --><?php 
			  ...
			  ?> and ordinary rate of F/P @ Rs. <?php 
							...
							/*if($pensioner->pay_commission==7)
								...
								{*/
									echo $pensioner->getOrdinaryRate();echo "/- PM+DR+MA"; echo "&nbsp;";echo $enhan_upto_seven_final;
									//} 
							?><!-- /-PM+DR+MA w.e.f <?php 
				...
				<td style="vertical-align: top;" colspan="2">
					...
					if($pensioner->provisional_gratuity>$pensioner->getDCRG())
						...
						echo $r;}
							...
							{echo '0';}
					?></br>
					e) Excess pay and Allowances Rs. <?php echo $pensioner->others; ?>
				</td>
				<td style="vertical-align: top;" colspan="2">
					b) Provisional RG/DG Rs. <?php echo $pensioner->provisional_gratuity; ?><br/>
					d) others If any Rs. <?php echo $pensioner->excess_pay_and_allowances; ?>
				</td>
			</tr>
			<tr>
					...
					<table width="100%" id="report" border="0">
						<tr>
							...
							<td>
								...
								<tr>
								<td height="100px">
									Name: <b><?php echo nbs(2).''. $spouse.'('.$spouse_type.') ';?>of<?php echo nbs(1).strtoupper($salutation." ".$pensioner->name); ?>, <?php echo nbs(1); ?>Ex. <?php echo $pensioner->designation; ?></b><br/>
