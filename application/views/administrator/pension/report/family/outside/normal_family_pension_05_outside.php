...
if($pensioner->dor==$pensioner->dod){
	...
	$ordinary_from=$enhan_upto->modify('+1 day');
	$ordinary_from_upto="<b> ".$ordinary_from->format('Y-m-d')." to untill her death or remarriage"."</b>";
	$amount_pension='N/A';
    $cpo_no="N/A";
	$salutation="Late";
	$commuted_value="N/A";
			  ...
			  i) Enhanced rate 						:- <b>Rs. <?php echo $pensioner->getEnhanceRate_sanjay(); ?></b>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
						...
						1) <b><?php echo strtoupper($pensioner->salutation." ".$pensioner->name).',<br />'.nbs(5).str_replace(",", ",<br />".nbs(5), $pensioner->address_after_retirement); ?></b><br /><br />
