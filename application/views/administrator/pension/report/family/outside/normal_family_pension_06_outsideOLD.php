...
if($pensioner->dor==$pensioner->dod){
    ...
    $paycomission=$pensioner->pay_commission_id;
    if ($paycomission == 7)
    {

      $amount_pension="<b>Rs.</b>".(($pensioner->total_amount)*(50/100))."/-PM+DR+MA";
    ...
    //$amount_pension="<b>Rs.</b>".$pensioner->getAmountofPension()."/-PM+DR+MA";//ceil($lastPay*50/100);
