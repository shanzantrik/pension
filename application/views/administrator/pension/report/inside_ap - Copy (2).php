...
<?php
	...
	//print_r(str_replace(", ", ",<br />",$pensioner->treasury_name));
?>
		...
		3. (a) Adhoc/Temporary increase
		    ...
		    (d) Family Pension in case of death of the Pensioner 	:- <b>Rs. <?php echo $pensioner->getAmountofPension(); ?>/- PM+DR+MA</b>
			  i) Enhanced rate 						:- <b>Rs. <?php echo $pensioner->getEnhanceRate(); ?></b>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4"><?php echo nbs(5); ?>e) Family pension (in case of death of the Govt. employee)<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;i) &nbsp;Enhance rate for a period of ten years<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ii)	Normal rate(on completion of ten years)<br/><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date of commencement of pension:-<?php echo $pensioner->dateTimeToDate($pensioner->effect_of_pension); ?></b></td>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
					6. Name of Treasury/Bank where payable 	:- <b><?php echo $pensioner->treasury_name; ?></b>
					</td>
				</tr>
				<tr>
					<td style="vertical-align: top;" colspan="4">
					7. Provisional pension Rs :- <b>Rs. <?php echo $pensioner->provisional_pension; ?></b>
					</td>
				</tr>
				<tr>
					<td style="vertical-align: top;" colspan="4">
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">Copy forwarded to:-
						...
						2) <b><?php echo $pensioner->office_address; ?></b><br />
	...
	<div id="print2" style="width: 1000px; margin: 0px auto;">
		<div style="width:1000px; min-height:600px; padding: 0 20px; font-size: 1.0em; color:#000000; background-color:#FFFFFF; line-height: 1.5em">
			...
			<table width="100%" border="0" cellpadding="2" id="report">
				...
				<tr>
					<td colspan="4"><div align="left" style="text-align: justify;">N.B: The date of payment may please be intimated to this office as soon as the gratuity debitable to local fund is paid.</b></div></td>
				</tr>
				<tr>
	...
	<div id="print3" style="width: 1000px; margin: 0px auto;">
		<div style="width:1000px; min-height:600px; padding: 0 20px; font-size: 1.0em; color:#000000; background-color:#FFFFFF; line-height: 1.5em">
			...
			<table width="100%" border="0" cellpadding="2" id="report">
				...
				<tr>
					<td colspan="4"><div align="left" style="text-align: justify;"><?php echo nbs(6); ?>I am to request you to make necessary arrangement for payment of <b>Rs.<?php echo $pensioner->getCommutationOfPension(); ?>/- (Rupees <?php echo no_to_words($pensioner->getCommutationOfPension());?>)</b> being the commuted value of <b>Rs. <?php //echo $reducePension; ?><?php echo $pensioner->getCommutedValue(); ?>/- (Rupees <?php echo no_to_words($pensioner->getCommutedValue());?>)</b> out of pension of <b>Rs. <?php echo $pensioner->getAmountofPension(); ?>/- (Rupees <?php echo no_to_words($pensioner->getAmountofPension());?>)</b> per month granted to <b><?php echo strtoupper($pensioner->salutation." ".$pensioner->name).", ".$pensioner->designation; ?></b>, holder of PPO No: - <b><?php echo $ppo_no; ?>.</b></div></td>
				</tr>
				<tr>
					<td colspan="4" style="padding: 10px 0;"><div align="left" style="text-align: justify;"><?php echo nbs(6); ?>Consequent on commutation, the reduced rate of pension in respect of <b><?php echo strtoupper($pensioner->salutation." ".$pensioner->name); ?></b> should be <b>Rs. <?php echo $pensioner->getOrdinaryRate(); ?>/- (Rupees <?php echo no_to_words($pensioner->getOrdinaryRate());?>)</b> per month. The reduction in the amount of pension shall become operative from the date of receipt of the commuted value of pension by the pensioner  or three months after the issue of authority whichever is earlier. A note to this effect may please be made on the on the reverse of both halves of PPO under your attestation quoting this letter as authority.</div></td>
				</tr>
				<tr>
					<td colspan="4" style="padding: 10px 0;"><div align="left" style="text-align: justify;"><?php echo nbs(6); ?>A separate bill should be prepared for the payment of commuted value of pension quoting the number and date of this authority and the paid voucher should be forwarded to this office in a registered cover in separate schedule.</div></td>
				</tr>			
				<tr>
					<td colspan="4" style="padding: 10px 0;"><div align="left" style="text-align: justify;"><?php echo nbs(6); ?>The expenditure is debitable to the Head of Account  ‘2071’ pension & ORB.</div></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3" width="25%" style="padding: 20px 0 25px 0;"><b>RECOVERY</b>: - Over payment, if any,<br/> due to non-payment of reduced pension<br/> of Rs.__________ per month should be<br/> adjusted at the time of payment.</td>
				...
				<tr>
					<td colspan="4" style="padding: 5px 0;"><div align="left">1.<b><?php echo strtoupper($pensioner->salutation." ".$pensioner->name).", Retd. ".$pensioner->designation; ?></b></div></td>
			    </tr>
			   	<tr>
					<td colspan="4" style="padding: 5px 0;">2. <b><?php echo $pensioner->office_address; ?></b></td>
				</tr>
				<tr>
					<td colspan="4" style="padding: 5px 0;">3.The Accountant General (A&E), Arunachal Pradesh, Itanagar.</td>
				</tr>
				<tr>
					<td colspan="3"></td>
					<td style="text-align: center;">Director/Joint Director</td>
	...
	<div id="print4" style="width: 1000px; margin: 0px auto;">
		<div style="width:1000px; min-height:600px; padding: 0 20px; font-size: 1.0em; color:#000000; background-color:#FFFFFF; line-height: 1.4em">
			...
			<table width="90%" border="0" cellpadding="2" id="report">
				...
				<tr>
					<td colspan="2" valign="top" valign="top" style="padding: 10px 0;"><div align="left"> 6.Anticipatory provisional pension and Anticipatory-Death /Retirements gratuity, already to be adjusted out of the final payments.</div></td>
					<td colspan="2" valign="top" style="padding: 10px 0;">
					...
					<tr>
				 	...
				 	<tr>
						<td style="vertical-align: top;" colspan="2"><b>
							...
							<?php echo $pensioner->treasury_name; ?>
						</td>
...
<script type="text/javascript">
	...
	function hideAll()
	{
		$('#form1, #form2, #form3, #form4, #disburser_disburser_portion, #disburser_pensioner_portion').hide();
	}
