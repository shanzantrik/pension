				...
				<tr>
					<td style="vertical-align: top;" colspan="3">
						<div id="heading" style="text-align:center; padding:10px; font:Arial, Helvetica, sans-serif; font-size:16px;font-weight:bold;">
					        <div class="style6" style="font-family: initial; margin-left: 200px;">GOVERNMENT OF ARUNACHAL PRADESH<br/>
				          DIRECTORATE OF AUDIT & PENSION<br/><u>NAHARLAGUN</u>.</div>
				      </div>
				  </td>
					<td></td>
				</tr>
			 	...
			 	<tr>
					<td style="vertical-align: top;" colspan="4" align="left"><div align="justify"><?php echo nbs(13); ?>The pension payment orders/GPO/CPO whose details are given below in favour of &nbsp;<b><?php echo strtoupper($name); ?>,  <?php echo $pensioner->designation;?>,<?php echo $pensioner->sub_designation;  ?></b>&nbsp;are forwarded herewith for payment from your end.</div></td>
				</tr>	
			 	<tr>
			 	<?php //echo $pensioner->pay_commission; ?>

					<td style="vertical-align: top;" colspan="4"><pre style="padding: 3px; margin: 10px 0 0 0; line-height:1.5em; font-family: 'Ubuntu', Tahoma, sans-serif; font-size: 14px; background-color: #fff!important; border: none; -webkit-border-radius: none; -moz-border-radius: none; border-radius: none;"><span class="style6">1. Pension Payment Order No. :- <b><?php echo $pensioner->case_file_no."/".$pensioner->ppo_no;?></b>
...
3. (a) Adhoc/Temporary increase
		   ...
		   // ?> <?php // }
			...
			(i) Enhanced rate :- <b> Rs. <?php echo $pensioner->getEnhanceRate(); ?></b></span>
</pre>				  </td>
			  </tr>
				<tr>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4"><?php echo nbs(5); ?>e) Family pension (in case of death of the Govt. employee)<br/>				      <?php echo nbs(11); ?>i) &nbsp;Enhance rate for a period of <?php echo no_to_words($enhance_rate_period); ?> years<br/>				    
					    <?php echo nbs(11); ?>ii)	Normal rate(on completion of 
				      <?php if($pensioner->class_of_pension=="Voluntary_Retirement_Pension" || $pensioner->class_of_pension=="Superannuation_Pension" || $pensioner->class_of_pension=="Invalid_Retirement_Pension" || $pensioner->class_of_pension=="Absorption_in_autonomous_body_pension" || $pensioner->class_of_pension=="Compulsory_Retirement_Pension" || $pensioner->class_of_pension=="Disability_Pension"){echo "seven";}else{echo "ten";}?> 
				    years)<br/>				    <?php echo nbs(14); ?>Date of commencement of pension :- <b><?php echo $pensioner->dateTimeToDate($pensioner->effect_of_pension); ?></b></td>
			  </tr>
				...
				<tr>
					<td colspan="3">&nbsp;</td>
			    <td><div style="margin-top: 13px;">Yours faithfully,<br/>
				      <br/>
				      Director/Joint Director</div></td>
               ...
               <table width="95%" cellpadding="3" id="report" border="0">
					...
					<tr>
				 	...
				 	<tr>
						...
						<td colspan="2" style="text-align:left;">Place for signature of pensioner to be<br/> taken at the time of first payment</td>
					</tr>
					<tr>
			...
			<div style="width:1000px; min-height:600px; padding: 0 10px; font-size: 1 em; color:#000000; background-color:#FFFFFF; line-height: 1.5em">
				<table width="95%" cellpadding="3" id="report" border="0">
					...
					<tr>
						<td style="vertical-align: top;" colspan="3">
							<div id="heading" style="text-align:center; padding:10px; font:Arial, Helvetica, sans-serif; font-size:16px">
						        <div style="font-family: initial; margin-left: 200px;margin-top:-22px; font-weight:bold">FORM-43<br/>(See paragraph 306)<br/>PENSION PAYMENT ORDER<br/>PENSIONER'S PORTION</div>
						    </div>
						</td>
						<td style="vertical-align: top;" align="right" rowspan="3"><div id="photograph" style="width: 150px; height: 128px; border: 1px solid #bababa; border-radius: 3px; -moz-border-radius: 3px; margin-top: 63px;"><p style="text-align: center; margin-top: 50px; font-weight: bold;">Photograph</p></div></td>
					</tr>
