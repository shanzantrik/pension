...
?>
	...
	<div id="print1" style="width: 1000px; margin: 0px auto;">
		<div style="width:1000px; min-height:600px; font-size: 1.2em; color:#000000; background-color:#FFFFFF; line-height: 1.5em; padding: 0 20px;">
	...
	<div id="print2" style="width: 900px; margin: 0px auto;">
		<div style="width:1000px; min-height:600px; font-size: 1.2em; color:#000000; background-color:#FFFFFF; line-height: 1.5em; padding: 0 20px;">
			...
			<table width="100%" border="0" cellpadding="2" id="report">
				...
				<tr>
					<td valign="top" style="padding: 10px 0;" colspan="5"><div align="right"><b>Total</b>= <?php echo $total; ?><br/>Rs <b><?php if(!$final_insurance_amt=="0"){ echo $final_insurance_amt;} else{echo $final_insurance_amt;}?></b></div></td>
				</tr>
				<tr>
					<td style="padding: 10px 0;"></td>
				...
				<tr>
					<td valign="top" style="padding: 10px 0;" colspan="5"><div align="left"></div></td>
				</tr> 
				<tr>
				...
				<tr>
					<td valign="top" style="padding: 10px 0;" colspan="5">
						...
						<div style="width: 30%; padding: 10px; float: left; text-align: center;">Approved<br/><br/><br/><br/>Sig. DAP</div>
						<div style="width: 30%; padding: 10px; float: left; text-align: center;">Recommended<br /><br /><br /><br/>Sig. JDAP</div>
					</td>
				</tr>
				<tr>
	            ...
	            <tr>
	            	<td valign="top" style="padding: 10px 0;" colspan="5"><div align="left"><?php echo nbs(6); ?>Name:- <b><?php echo $val['salutation']?><?php echo nbs(2);?><?php echo $val['pensionee_name']?></b><?php echo nbs(6); ?>Village/Town:- <b><?php echo $val['village_town']?></b></div></td>
	            </tr>
	            <tr>
	            	<td valign="top" style="padding: 10px 0;" colspan="5"><div align="left"><?php echo nbs(6); ?>Post Office:- <b><?php echo $val['po']?></b><?php echo nbs(6); ?>District:- <b><?php echo $val['district']?></b><?php echo nbs(6); ?>State:- <b><?php echo $val['state']?></b></div></td>
	            </tr>
				<tr>
					<td valign="top" style="padding: 10px 0;">20.</td>
					<td valign="top" style="padding: 10px 0;" colspan="5"><div align="left"><strong>Record of Issue of Authority:-</strong></div></td>
			   </tr>
