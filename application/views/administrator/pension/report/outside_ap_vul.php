...
//print_r($pensioner);
//print_r($pensioner->pay_info[1]['increament_GP']);
//printf($pensioner->class_of_pension);
...
<?php
	...
	//$ac = ($pensioner->treasury_officer!='') ? str_replace(", ", ",<br />",getTreasury($pensioner->treasury_officer)): str_replace(", ", ",<br />", $pensioner->accountant_general_name);
    //$ac = ($pensioner->treasury_officer!='') ? strgetTreasury($pensioner->treasury_officer): str_replace(", ", ",<br />", $pensioner->accountant_general_name);
    //print_r(str_replace(", ", ",<br />",$ac));
    $ac = ($pensioner->treasury_officer!='') ? str_replace(", ", ",<br />", $pensioner->treasury_name): str_replace(", ", ",<br />", $pensioner->accountant_general_name) ;
     //print_r($ac);
    //print_r(str_replace(", ", ",<br />","adaddad,jjhj,kjkj"));
?>
		...
		3. (a) Adhoc/Temporary increase
		    ...
		    (d) Family Pension in case of death of the Pensioner 	:- <b>Rs. <?php echo $pensioner->getAmountofPension(); ?>/- PM+DR+MA</b>
			  i) Enhanced rate 						:- <b>Rs. <?php echo $pensioner->getEnhanceRate(); ?></b>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
					6. Name of Treasury/Bank where payable 	:- <b><?php echo $pensioner->bank_name; //echo $pensioner->sub_to;?></b>
					</td>
				</tr>
				<tr>
					<td style="vertical-align: top;" colspan="4">
				...
				<table width="100%" cellpadding="3" id="report" border="0">
					...
					<tr>
						<td style="vertical-align: top; text-align: justify;" colspan="4">
							<?php echo nbs(6); ?>UNTIL FURTHER NOTICE and on the expiration of every month, be pleased to pay to <b><?php echo strtoupper($pensioner->salutation." ".$pensioner->name); ?>, Rtd. <?php echo $pensioner->designation; ?></b>, a sum of <b>Rs. <?php echo $pensioner->getAmountofPension(); ?>/-</b> only (less income-tax), being the amount of <b><?php echo strtoupper(str_replace("_", " ", $class_of_pension)); ?></b>, as Arunachal Pradesh Government Pensioner upon the production of this Order and a receipt according to usual form.<br/>
				...
				<div style="width:1000px; min-height:600px; font-size: 1.0em; color:#000000; background-color:#FFFFFF; line-height: 1.4em">
					<table id="report" border="0" cellpadding="3" width="100%">
						<tbody>
							...
							<tr>
								<td colspan="3" style="padding-top:40%" height="400px">
									<table width="100%" border="1">
										<tr>
											<td><b><h2>1</h2></b></td>
											<td><h2>NAME OF THE PENSIONER</h2></td>
											<td width="40%"><b><h2><?php echo $pensioner->salutation." ".$pensioner->name?></b></h2></td>
										</tr>
										<tr>
											<td><b><h2>2</h2></b></td>
											<td><h2>DESIGNATION</h2></td>
											<td><b><h2><?php echo $pensioner->designation; ?></h2></b></td>
										</tr>
										<tr>
											<td><b><h2>3</h2></b></td>
											<td><h2>SERVICE TO WHICH BELONG</h2></td>
											<td><b><h2>IFS</h2></b></td>
										</tr>
										<tr>
											<td><b><h2>4</h2></b></td>
										...
										<tr>
											<td><b><h2>5</h2></b></td>
											<td><h2>DATE OF RETIREMENT</h2></td>
											<td><b><h2><?php echo $pensioner->dor;?></h2></b></td>
										</tr>
										<tr>
											<td><b><h2>6</h2></b></td>
											<td><h2>DATE OF COMMENCEMENT OF PENSION</h2></td>
											<td><b><h2><?php echo $pensioner->effect_of_pension; ?></h2></b></td>
										</tr>
							...
							<td style="padding: 30px 0;">
								<table width="100%" cellspacing="3" cellpadding="3" border="1">
									...
									<tr>
										...
										<td valign="top"><b><?php echo $pensioner->getNameOfLegalHeir(); ?><br><?php echo $pensioner->getNameofChild();?></b></td>
