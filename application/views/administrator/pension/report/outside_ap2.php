		...
		<?php if($class_of_pension=='Liberalised_Pension'){?>
			<table width="100%" cellpadding="3" id="report" border="0">
				...
				<tr>
			 	...
			 	<tr>
					<td style="vertical-align: top;" colspan="4" align="left"><?php echo nbs(13); ?>The pension payment orders/GPO/CPO whose details are given below in favour of <b><?php echo $pensioner->getNameOfLegalHeir(); ?><?php echo nbs(1); ?>of <?php echo strtoupper($name); ?>,  <?php echo $pensioner->designation;?>,<?php echo $pensioner->sub_designation;  ?></b>&nbsp;are forwarded herewith for payment from your end.</td>
				</tr>	
			 	<tr>
			  ...
			  i) Enhanced rate :- <b> Rs. N/A/-</b>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
						...
						<b>1) <?php echo $pensioner->getNameOfLegalHeir(); ?><?php echo nbs(1); ?>of <?php echo strtoupper($name).',<br />'.nbs(5).str_replace(",", ",<br />".nbs(4), $pensioner->address_after_retirement).$pin; ?></b><br />
				...
				<tr>
					...
					<td style="vertical-align: top; padding-top: 0px;">Director/Joint Director</td>
			  ...
			  i) Enhanced rate :- <b> Rs. <?php echo $pensioner->getEnhanceRate(); ?>/- PM<?php echo $pensioner->getDRMA(); ?></b>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
						<?php $pin = ($pensioner->pin != '') ? '<br />'.nbs(5).'PIN Code - '.$pensioner->pin : ''; ?>
						Copy forwarded to:- <br />
						<b>1) <?php echo strtoupper($name).',<br />'.nbs(5).str_replace(",", ",<br />".nbs(4), $pensioner->address_after_retirement).$pin; ?></b><br />
						<b>2) <?php echo str_replace(",", ",<br />".nbs(4), $pensioner->office_address); 
						?></b> for information with reference to letter No. <b><?php echo $pensioner->dept_forw_no; ?></b>. The enclosures which are no longer required are returned herewith.<br/>
						<b>3) The Accountant General (A&E) Arunachal Pradesh, Itanagar.</b>
					</td>
