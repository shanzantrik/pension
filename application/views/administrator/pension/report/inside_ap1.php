  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please acknowledge receipt.</p></td>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
						...
						<br/>
						<b>2) The <?php echo str_replace(",", ",<br />".nbs(4), $pensioner->office_address); ?></b> for information with reference to letter No. <b><?php echo $pensioner->dept_forw_no; ?></b>. The enclosures which are no longer required are returned herewith.<br/>
			...
			<table width="100%" border="0" cellpadding="2" id="report">
			   ...
			   <tr>
				...
				<tr>
			   	...
			   	<tr>
					<td colspan="4" width="25%"><div style="float: left;"><b>ii.</div><div style="float: left;margin-left: 5px;">The <?php echo $pensioner->office_address; ?></b></div></td>
				</tr>
				<tr>
...
<table width="100%" border="0" cellpadding="2" id="report">
				...
				<tr>
					<td colspan="4" valign="top" style="padding: 10px 0;"><div align="left">1.The <?php echo $pensioner->office_address; ?></div></td>
				</tr>
	    		<tr>
...
<div id="disburser_disburser_portion" style="display:none" >
  <button style="float:right;" class="btn btn-info" onclick="javascript:printReport('print6')"><i class="icon-white icon-print"></i>Print</button>
		<div id="print6" style="width: 1000px; margin: 0px auto;">
		  <div style="width:1000px; min-height:600px; padding: 0 10px; font-size: 1.1em; color:#000000; background-color:#FFFFFF; line-height: 1.5em;">
            ...
            <table width="95%" cellpadding="3" id="report" border="0">
					...
					<tr>
						<td style="vertical-align: top;" colspan="3">
							<div id="heading" style="text-align:center; padding:10px; font:Arial, Helvetica, sans-serif; font-size:16px">
						        <div style="font-family: initial; margin-left: 300px;font-weight:bold;margin-top:-25px;">FORM-43<br/>(See paragraph 306)<br/>PENSION PAYMENT ORDER<br/>DISBURSER'S PORTION</div>
						    </div>						</td>
					...
					<tr>
						<td style="vertical-align: top;" colspan="4"><strong>Name of his wife / her husband: <?php echo $pensioner->getNameofSpouse(); ?></strong></td>
					</tr>
					<tr>
						<td style="vertical-align: top;" colspan="4">
							<table border="1" cellspacing="0" cellpadding="0" width="100%" id="inner-table">
								<tr>
									...
									<td width="20%" style="vertical-align: top; text-align: center;"><strong>Date of Birth</strong></td>
									<td width="20%" style="vertical-align: top; text-align: center;"><strong>Religion and Nationality</strong></td>
									<td width="20%" style="vertical-align: top; text-align: center;"><strong>Residence showing village pargana</strong></td>
								...
								<tr>
									...
									<td style="vertical-align: top; text-align: center;" width="20%"><strong><?php echo $pensioner->dateTimeToDate($pensioner->dob); ?></strong></td>
									<td style="vertical-align: top; text-align: center;" width="20%"><strong><?php echo $pensioner->religion.", ".$pensioner->nationality;?></strong></td>
									<td style="vertical-align: top; text-align: center; font-size: 12px;" width="20%"><strong><?php echo strtoupper($name).'<br />'.$pensioner->address_after_retirement; ?></strong></td>
		    ...
		    ?><br/>
					...
					<tr>
						<td style="vertical-align: top;" colspan="4"><strong>
						...
						<td colspan="2">
							<table border="0" cellspacing="2" cellpadding="2" width="100%">
								<tr>
									...
									<td width="3%">:</td>
									<td width="77%"><?php echo $pensioner->pay_scale; ?>/<?php echo $pensioner->pay_scale_grade; ?></td>
								</tr>
								<tr>
					...
					<tr>
						<td style="vertical-align: top; text-align: justify;" colspan="4">
							<strong><?php echo nbs(6); ?>UNTIL FURTHER NOTICE and on the expiration of every month, be pleased to pay to <?php echo strtoupper($name); ?>, Rtd. <?php echo $pensioner->designation; ?>, a sum of Rs. <?php echo $pensioner->getAmountofPension(); ?>/- PM<?php echo $pensioner->getDRMA(); ?> only (less income-tax), being the amount of <?php echo strtoupper(str_replace("_", " ", $class_of_pension)); ?>, as Arunachal Pradesh Government Pensioner upon the production of this Order and a receipt according to usual form.<br/>
							...
							<?php
									...
									echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.In the event of the death of <b>'.strtoupper($name).'</b>, Family Pension of <b>Rs. '.$pensioner->getAmountofPension().'/- PM'.$pensioner->getDRMA().'</b>, may be paid to <b>'.$pensioner->getNameofSpouse().'</b>, whose date of birth is <b>'.$pensioner->getDOBofSpouse().' </b> from the day following the date of death of <b>'.strtoupper($name).'</b> for a period of 7 years, or for a period up to the date on which '.$pensioner->pensioner_pronoun.' would have attained the age of '.$pensioner->pension_attained_age.'/67 years, had '.$pensioner->pensioner_pronoun.' survived, whichever is less; thereafter normal rate of Family pension of <b>Rs. '.$pensioner->getOrdinaryRate().'/- PM'.$pensioner->getDRMA().'</b>, till the date of her/his remarriage or death whichever is earlier (on receipt of death certificate and Form of application from widow/widower). Further, the quantum of pension/Family pension shall be increased as follows:-<br />';	
					...
					<tr>
						<td colspan="4" style="border:1px solid#000">
						  <strong>Quantum of Additional Pension/Family Pension<br/>
							1.Age W.e.f <?php echo $pensioner->dateTimeToDate($year80);?> to <?php echo $pensioner->dateTimeToDate($year85); ?>(80 yrs.) 20% increase on  Rs. <?php echo $pensioner->getAmountofPension(); ?>= 
							...
							?> 
							to <?php echo $pensioner->dateTimeToDate($year95); ?>(90 yrs.) 40% increase on  Rs. 
					...
					<tr>
						<td style="vertical-align: top;" colspan="4"><strong>RECOVERIES</strong></td>
					</tr>
					...
					<tr>
						<td style="vertical-align: top;" colspan="4"><strong><u>N.B.:- The Specimen Signature/Descriptive Roll/Identification Mark are enclosed.</u></strong></td>
					</tr>
					<tr>
						<td colspan="3" align="right"><div align="left"><strong>To<br/>
				      The Treasury Officer</strong></div></td>
					    <td align="right"><strong>Signature_________________</strong></td>
					</tr>
				 	<tr>
						<td style="vertical-align: top;" colspan="2"><strong><?php echo $pensioner->treasuryOfficer(); ?>
						</strong></td>
		    ...
		    ?>
					...
					<tr>
						<td colspan="4" style="border:1px solid#000">
							...
							$year100plus1 = date_format($year100plus,"Y-m-d");
							echo $pensioner->dateTimeToDate($year100plus1);?> 
							to (100 yrs.) onwards 100% increase on  Rs. <?php echo $pensioner->getAmountofPension(); ?>= <?php echo round((100*$pensioner->getAmountofPension())/100)+$pensioner->getAmountofPension(); ?></strong><br />						</td>	
					</tr>
					<tr style="height:0px;"></tr>
					<tr>
