...
<?php 
    foreach ($vals as $vl) {
        $dept=$vl->dept_name; 
        $dept_addr=$vl->address;
        $dept_file_no=$vl->file_no;
        $dept_frwrd_no=$vl->dept_forw_no;
        $receipt_date=$vl->receipt_date;
...
<div id="print" style="width:1000px; min-height:600px; color:#000000; background-color:#FFFFFF">
   ...
   <table width="60%" border="0" align="center" cellpadding="2" id="report">
    ...
    <td></td>
    <td colspan="2"><div align="left">The<br>
     <?php echo $dept;?><br />
     <?php echo $dept_addr;?>
      ...
      <tr>
	     ...
	     <tr>
		  ...
		  <tr>
			...
			<td colspan="2"><b>Your letter  <?php echo $dept_frwrd_no;?> Nodtd<?php echo $val['receipt_date'];?></b></td>
		    </tr>
        ...
        <tr>
      <td><div align="left"></div></td>
      <td colspan="2"><b><?php echo $val['name'];?>,<?php echo $val['designation'];?></b></td>
        </tr>
          <tr>
      <td><div align="left"></div></td>
