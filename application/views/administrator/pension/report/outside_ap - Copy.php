...
<div style="float: left;">&nbsp;<b><?php echo $pensioner->getNameOfLegalHeir(); ?>, <br /><?php echo nbs(1); ?> of <?php echo nbs(1).strtoupper($name); ?>  Rtd. <?php echo $pensioner->designation; ?></b></div>
