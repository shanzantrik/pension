	...
	<div style="width:1000px; min-height:600px; font-size: 1.2em; color:#000000; background-color:#FFFFFF; line-height: 1.5em">
		...
		<table width="100%" border="0" cellpadding="2" id="report">
			...
			<tr>
				...
				<td valign="top"><b>Service Gratuity</b></td>
				<td valign="top">:</td>
				<td valign="top" colspan="3">
					<?php echo $pensioner->getServiceGratuity(); ?>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td valign="top"><b>Terminal Gratuity</b></td>
				<td valign="top">:</td>
				<td valign="top"><?php echo $pensioner->getTerminalGratuity(); ?></td>
			</tr>
			<tr>
