	...
	<div style="width:1000px; min-height:600px; font-size: 1.2em; color:#000000; background-color:#FFFFFF; line-height: 1.5em">
		...
		<table width="100%" border="0" cellpadding="2" id="report">
			...
			<tr>
				...
				if($pensioner->class_of_pension=='Death_Gratuity')
				{
					echo 'N/A';
				}
				else
			...
			<tr>
				...
				//echo $pensioner->getEnhanceRate(); 
					...
					if($EntryYear>='2006') //2008
					{ echo 'N/A';
					}
					elseif($EntryYear<'2006') //2008
					{
			...
			<tr>
				...
				<td valign="top">:</td>
				<td valign="top"><?php echo str_replace(['_', 'Normal'], " ", $pensioner->class_of_pension).' ('.$pensioner->pensionRule().')'; ?></td>
			</tr>
			<tr>
