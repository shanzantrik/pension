	...
	<div id="print1" style="width: 1000px; margin: 0px auto;">
		...
		3. (a) Adhoc/Temporary increase
		   ...
		   // ?> <?php // }
		    ...
		    (d) Family Pension in case of death of the Pensioner 	:- <b>Rs. <?php echo $pensioner->getAmountofPension();?>/- PM</b>
			  i) Enhanced rate :- <b> Rs. <?php echo $pensioner->getEnhanceRate(); ?></b>
				...
				<tr>
					<td style="vertical-align: top;" colspan="4">
						...
						1) <?php echo strtoupper($name).',<br />'.nbs(5).str_replace(",", ",<br />".nbs(4), $pensioner->address_after_retirement).$pin; ?><br />
			...
			<div style="width:1000px; min-height:600px; font-size: 1em; color:#000000; background-color:#FFFFFF; line-height: 1.5em">
				...
				<table width="95%" cellpadding="3" id="report" border="0">
					...
					<tr>
						<td style="vertical-align: top;" colspan="3">
							<div id="heading" style="text-align:center; padding:5px; font:Arial, Helvetica, sans-serif; font-size:16px">
						        <!-- <div style="font-family: initial; margin-left: 200px;margin-top:-22px;"> -->
						        <div style="font-weight: bold;font-family: initial; margin-left: 200px;">
		    ...
		    ?></b></td>
					...
					<tr>
						<td style="vertical-align: top;" colspan="2">
							...
							c) Excess Gratuity Paid : <?php echo $pensioner->provisional_gratuity - $pensioner->getDCRG(); ?> <br/>
