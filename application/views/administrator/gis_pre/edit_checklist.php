...
<td><input title="joining Date" name="doj" id="doj" type="text" value="<?php echo $record['doj']?>" class="form-control parsley-validated" placeholder="Provide Date of Retirement"><?php echo form_error('doj', '<div class="error">', '</div>'); ?></td>        
            ...
            <td><textarea  name="office_address" placeholder="Please Enter Remarks" value="<?php echo $office_address;?>" class="form-control parsley-validated"><?php echo $office_address?><?php echo set_value('office_address'); ?></textarea><?php echo form_error('office_address', '<div class="error">', '</div>'); ?><br/></td>                         
                    </tr>
                    <tr>
