                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php  
                            ...
                            if($status=="Forwarded to IPS" ||$status=="Forwarded to IPS From Receipt") { ?>
                                <td><a title="Attach IPS for this claimant from receipt branch" href="<?php echo site_url('/administrator/Ips/edit_ips/'.base64_encode($list->file_no))?>/Pension" class="open-dialog-edit btn btn-success btn-rad" data-id=""><i class="icon-book"></i>Edit</a>
                                  <a title="Attach IPS for this claimant from receipt branch" href="<?php echo site_url('/administrator/Ips/print_ips/'.base64_encode($list->file_no))?>/Pension" class="open-dialog-edit btn btn-success btn-rad" data-id=""><i class="icon-book"></i>Print</a></td>
                            <?php } else { ?>
                                <td><a title="Attach IPS for this claimant from receipt branch" href="" class="btn btn-warning" data-id=""><i class="icon-book"></i>Forwarded</a></td>
                            <?php } ?>
                    </tr>
