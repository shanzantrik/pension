...
<form class="form-horizontal group-border-dashed" action="<?php echo site_url('administrator/ips/add_ips_from/'.base64_encode($file_no).'/'.$type); ?>" method="post" parsley-validate="" novalidate="" autocomplete="off">
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    <tr>
                     ...
                     <tr>
                        ...
                        <td><input title="Designation" readonly name="receipt_date"  type="date" class="form-control parsley-validated" value="<?php echo $row['receipt_date']; ?>"><?php echo form_error('member_name', '<div class="error">', '</div>');?></td>                                                    
                    </tr>
                    <tr>
            ...
            <table class="table" id="myTable" style="margin-top: 10px;">
                <tbody>
                    <tr id="parent-1" class="parent">
                        ...
                        <td><input required class="dob form-control" name="date[]" placeholder="Date" size="16" type="text" value=""><label style="font-size:12px; color:red">Date<span class="required-field">*</span></label></td>
                        ...
                        <td><textarea rows="4" cols="4" name="remark" id="remark" class="form-control"></textarea><label style="font-size:12px; color:red">Remarks</label></td>
