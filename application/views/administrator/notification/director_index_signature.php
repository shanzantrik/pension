<form method="post" action="<?php echo site_url('administrator/director_notification/forward_to_issue') ?>">
...
<br/>
<a href="#forwrd" class="open-dialog btn btn-success btn-rad" data-toggle="modal"><i class=""></i>Forward To Issue Branch</a>
<div id="forwrd" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Forward To Issue Branch</h4>
            </div>
            <div class="modal-body">
                Are You Sure Want to Forward to Issue
            </div>
