        ...
        <?php $i=100000; ?>
            <?php foreach ($records as $rec): ?>
                <tr>
                    ...
                    <td><a title="Attach IPS for this claimant from receipt branch" href="<?php echo site_url('/administrator/Ips/edit/'.base64_encode($rec->file_no))?>/Receipt" class="open-dialog-edit btn btn-success btn-rad" data-id=""><i class="icon-book"></i>Attach IPS</a></td>
                </tr>
            <?php endforeach ?>
