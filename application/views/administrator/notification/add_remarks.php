...
<form class="form-horizontal group-border-dashed" action="<?php echo site_url('administrator/da_notification/add_remarks_controller/'/*.base64_encode($file_no)*/); ?>" method="post" parsley-validate="" novalidate="" autocomplete="off">
