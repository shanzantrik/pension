<form method="post" action="<?php echo site_url('administrator/notification/save_forwrd3') ?>">
...
<br/>
<a href="#forwrd" class="open-dialog btn btn-success btn-rad" data-toggle="modal"><i class=""></i>Forward To Director</a>
...
<script type="text/javascript">
    ...
    function ajax(x,y){
        $.ajax({
            url:"<?php echo site_url('administrator/notification/confirm_tab3').'?file=' ?>"+x,
            dataType:'json',
            type:'GET',
