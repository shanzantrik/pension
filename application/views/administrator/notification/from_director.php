<form method="post" action="<?php echo site_url('administrator/notification/save_forwrd_DA') ?>">
...
<br/>
<a href="#forwrd" class="open-dialog btn btn-success btn-rad" data-toggle="modal"><i class=""></i>Forward To Concern Delaing Assistant</a>
<div id="forwrd" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Forward To Receipt </h4>
            </div>
            <div class="modal-body">
                Forward to Concern Dealing Assistant
