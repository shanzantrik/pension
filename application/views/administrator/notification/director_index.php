<form method="post" action="<?php echo site_url('administrator/director_notification/save_forwrd_PPO') ?>">
        ...
        <?php $i=100000; ?>
            <?php foreach ($records as $rec): ?>
                <tr>
                    ...
                    <td><?php $x=$this->model_notification->get_last_member($rec->file_no); print_r($x[1]) ?></td>
                    <td>
...
<br/>
<a href="#forwrd" class="open-dialog btn btn-success btn-rad" data-toggle="modal"><i class=""></i>Forward To Superendintent</a>
<div id="forwrd" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Forward To Superintendent </h4>
            </div>
            <div class="modal-body">
                Are You Sure Want to Forward to Concern Superintendent of Pension
...
<script type="text/javascript">
    ...
    function ajax(x,y){
        $.ajax({
            url:"<?php echo site_url('administrator/director_notification/director_confirm').'?file=' ?>"+x,
            dataType:'json',
            type:'GET',
