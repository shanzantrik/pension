<form method="post" action="<?php echo site_url('administrator/da_notification/forwrd_to_superintendent') ?>">
...
<br/>
<a href="#forwrd" class="open-dialog btn btn-success btn-rad" data-toggle="modal"><i class=""></i>Forward To Superintendent</a>
...
<script type="text/javascript">
    ...
    function ajax(x,y){
        $.ajax({
            url:"<?php echo site_url('administrator/da_notification/confirm_from_superandant').'?file=' ?>"+x,
            dataType:'json',
            type:'GET',
