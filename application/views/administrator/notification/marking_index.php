<form method="post" action="<?php echo site_url('administrator/marking_notification/save') ?>">
<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered dataTable">
        ...
        <?php $i=100000; ?>
            <?php foreach ($records as $rec): ?>
                <tr>
                    <td><input <?php if($rec->notification=='pending'){echo "style='display:none'";}else{echo "style='display:show'";} ?> type="checkbox" id="chk_<?php echo $i?>" name="chk[]" class="checkbox1" value="<?php echo $rec->file_no ?>"></td>
...
<script type="text/javascript">
    ...
    function ajax(x,y){
        $.ajax({
            url:"<?php echo site_url('administrator/marking_notification/confirm').'?file=' ?>"+x,
            dataType:'json',
            type:'GET',
