...
class Model_gis_superintendent extends CI_Model
{
	...
	//function getAll_file_DA()
	 //{
	    //$q=$this->db->query("SELECT * from file_status a,pension_receipt_file_master b where a.file_no=b.file_No and a.status='Forwarded to GIS_Superintendent By GIS DA'");
    	//$result = $q->result();
 		//return $result;
	 //}
	 	function getAll_file_DA()
