...
class Model_pension extends CI_Model {
    ...
    function add_revision_rg() {
  		//$id			        				= $this->model_pension->getMaxId();
  		$case_no            				= $this->security->xss_clean($this->input->post('case_no'));
		$revision_type_rg					= $this->security->xss_clean($this->input->post('revision_type_rg'));
		$dod 								= $this->security->xss_clean($this->input->post('dod'));
		$revised_scale_pay 					= $this->security->xss_clean($this->input->post('revised_scale_pay'));
		$last_pay_rg 						= $this->security->xss_clean($this->input->post('last_pay_rg'));
		$grade_pay_rg 		    			= $this->security->xss_clean($this->input->post('grade_pay_rg'));
		$revised_total_rg					= $this->security->xss_clean($this->input->post('revised_total_rg'));
		$revision_da_rg 					= $this->security->xss_clean($this->input->post('revision_da_rg'));

		//$average_emolument					= $this->security->xss_clean($this->input->post('average_emolument'));
		$amount_of_pension_pre_revised_rg		= $this->security->xss_clean($this->input->post('amount_of_pension_pre_revised_rg'));
		//$fifty_of_ae 						= $this->security->xss_clean($this->input->post('fifty_of_ae'));
		//$fifty_of_last_pay 					= $this->security->xss_clean($this->input->post('fifty_of_last_pay'));
		//$pay_band_pay 						= $this->security->xss_clean($this->input->post('pay_band_pay'));
	 	//$pay_band_grade_pay    				= $this->security->xss_clean($this->input->post('pay_band_grade_pay'));
	 	//$fifty_of_pay_band_plus_grade_pay	= $this->security->xss_clean($this->input->post('fifty_of_pay_band_plus_grade_pay'));
  		//$revised_amount_of_pension			= $this->security->xss_clean($this->input->post('revised_amount_of_pension'));
		$revised_dcrg_rg 					= $this->security->xss_clean($this->input->post('revised_dcrg_rg'));
		$prerevised_dcrg_rg 				= $this->security->xss_clean($this->input->post('prerevised_dcrg_rg'));
		$total_payable_rg 						= $this->security->xss_clean($this->input->post('total_payable_rg'));
	  	//$revised_enhance_rate 				= $this->security->xss_clean($this->input->post('revised_enhance_rate'));
	  	//$revised_ordinary_rate				= $this->security->xss_clean($this->input->post('revised_ordinary_rate'));
	  	//$re_com_applied          			= $this->security->xss_clean($this->input->post('re_com_applied'));
	 	//$pre_revised_cop          			= $this->security->xss_clean($this->input->post('pre_revised_cop'));
		...
		$pensioner_revision = array('case_no'=>$case_no,'revision_type'=>$revision_type_rg, 'dod'=>$dod, 'revised_scale_pay'=>$revised_scale_pay, 'last_pay'=>$last_pay_rg, 'grade_pay'=>$grade_pay_rg, 'revised_total'=>$revised_total_rg,'amount_of_pension_pre_revised'=>$amount_of_pension_pre_revised_rg,'revision_da'=>$revision_da_rg, 'revised_dcrg'=>$revised_dcrg_rg, 'prerevised_dcrg'=>$prerevised_dcrg_rg, 'total_payable'=>$total_payable_rg,'treasury'=>$treasury,'pension_enhanced'=>$pension_enhanced);
		//print_r($pensioner_revision);
		//exit();
        if($this->db->insert('pensioner_revision', $pensioner_revision)) :
        	return true;
        else :
