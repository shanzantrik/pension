...
class Reauthorization extends CI_Controller
{
	...
	function get_report($serial_no,$file_no,$sal)
	{    
	     $file_no=base64_decode($file_no);
		 $this->load->helper('pension/superannuation_after/superannuation_pension');
		 $pid['sal']=$sal;
		 $pid['values'] = $this->model_Reauthorization->get_reauthorization_details($file_no);
	...
	function search_family()
	{
	  ...
	  $vrp['reautho_details'] = $this->model_Reauthorization->get_reauthorization_details($file_no);
