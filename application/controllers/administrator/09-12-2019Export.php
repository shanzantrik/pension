...
class Export extends CI_Controller {
    ...
    public function index() {
        ...
        $this->db->join('issue', 'issue.file_no = file_tracking_temp.file_no','left');
